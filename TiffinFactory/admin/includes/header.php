                        ...
                        <ul class="list-style-none">
                            <li>
                                ...
                                <div class="message-center notifications position-relative">
                                    ...
                                    ?>
                                        <a href="new-order.php" class="message-item d-flex align-items-center border-bottom px-3 py-2">
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        if ($query->rowCount() > 0) {
                            foreach ($results as $row) {               ?>
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span class="text-dark"><?php echo $row->AdminName; ?></span> <i data-feather="chevron-down" class="svg-icon"></i></span><?php $cnt = $cnt + 1;
                                                                                                                                                                                                                        }
                                                                                                                                                                                                                    } ?>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        <a class="dropdown-item" href="admin-profile.php"><i data-feather="user" class="svg-icon mr-2 ml-1"></i>
                            My Profile</a>

                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="change-password.php"><i data-feather="settings" class="svg-icon mr-2 ml-1"></i>
                            Change Password</a>
                        <div class="dropdown-divider"></div>
