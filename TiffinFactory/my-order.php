...
?>
	...
	<head>
		<title>Tiffin Factory | My Order </title>
							...
							<div class="cart-sec simpleCart_shelfItem">
								...
								<div class="cart-item-info">
									...
									<ul class="qty">
										...
										<li><span style="font-weight:bold">Total Days:</span> <?php echo $ddf = $row->ddf; ?></p>
										</li>
										<li><span style="font-weight:bold">Total Cost:</span> <?php echo $row->TotalCost; ?></p>
										</li>
									</ul>
									<div class="delivery">
