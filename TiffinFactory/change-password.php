...
?>
	...
	<head>
		<title>Tiffin Factory | Change Password </title>
						...
						<div class="col-md-6 contact_left wow fadeInRight" data-wow-delay="0.4s">
							...
							<form method="post" onsubmit="return checkpass();" name="changepassword">
								<div>
									...
									<p style="font-size: 20px;color: blue;"><strong>New Password:</strong><br /><input type="password" class="form-control" required="true" name="newpassword" style="font-size: 20px"></p>
