...
<head>
	<title>Tiffin Factory | Forget Password </title>
				...
				<div class="account_grid">
					...
					<div class="col-md-6 login-right wow fadeInRight" data-wow-delay="0.4s">
						...
						<form method="post" name="chngpwd" onSubmit="return valid();">
							...
							<div>
								<span><label>Password</label> <i class="fas fa-user-lock" aria-hidden="true"></i></span>
								<input type="password" placeholder="New Password" name="newpassword" required="true">
							</div>
							<div>
								<span><label>Confirm Password</label> <i class="fas fa-user-shield" aria-hidden="true"></i></span>
