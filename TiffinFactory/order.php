...
?>
	...
	<head>
		<title>Tiffin Factory | Order </title>
				...
				<div class="contact_top">
					<div class="container">
						<div class="col-md-8 contact_left wow fadeInRight" data-wow-delay="0.4s">
							...
							<h5>Ordering Food Was Never So Simple !!!!!!.</h5>
							<form method="post">
								<div class="form_details">
									...
									?>
										<p>Name</p>
										<input type="text" class="text" placeholder="Name" readonly="true" name="fullname" style="margin-top: -1%" value="<?php echo htmlentities($result->FullName) ?>">
										<div class="clearfix"> </div>
										<p>Email Id </p>
										<input type="text" class="text" placeholder="Email Address" readonly="true" name="email" style="margin-top: -1%" value="<?php echo htmlentities($result->Email) ?>">
										<div class="clearfix"> </div>
										<p>Mobile No. </p>
										<input type="text" class="text" placeholder="Mobile Number" maxlength="10" pattern="[0-9]+" readonly="true" name="mobnum" style="margin-top: -1%" value="<?php echo htmlentities($result->MobileNumber) ?>">
										<div class="clearfix"> </div>
									<?php } ?>
									<p>Quantity:</p>
									<input type="text" class="text" placeholder="eg:1,2 etc." required="true" name="quantity" style="margin-top: -1%">
									<div class="clearfix"> </div>
									<p>From Date: </p>
